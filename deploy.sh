...
docker build -t shicknventive/multi-client:latest -t shicknventive/multi-client:$SHA -f ./client/Dockerfile ./client
docker build -t shicknventive/multi-server:latest -t shicknventive/multi-server:$SHA -f ./server/Dockerfile ./server
docker build -t shicknventive/multi-worker:latest -t shicknventive/multi-worker:$SHA -f ./worker/Dockerfile ./worker
